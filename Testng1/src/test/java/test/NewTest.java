...
public class NewTest {
  ...
  public void f() {
	// navigate to the web site
	  ...
	  driver.findElement(By.id("login-username")).sendKeys("Harsha@yahoo.in"); //id locator for text box
  ...
  public void beforeMethod() {
	// set path of Chromedriver executable
      System.setProperty("webdriver.chrome.driver",
             "C:\\Users\\Harshini Arasu\\Downloads\\chromedriver_win32\\chromedriver.exe");
